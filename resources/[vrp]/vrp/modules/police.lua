...
RegisterServerEvent('handcuff:cuffHim', function()
    ...
    PerformHttpRequest(webhook.HoneyPot, function(err, text, headers) end, 'POST', json.encode({username = 'SenturaCloud - Logs', content = 'ID: '..user_id..' Forsøgte at trigger "handcuff:cuffHim"'}), { ['Content-Type'] = 'application/json' })
  end
end)
